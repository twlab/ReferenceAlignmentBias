...
python3 /scratch/twlab/tekkey/PhasingData/scripts/partitionReadsRNA.py $FastQR1_without_extension $FastQR2_without_extension $CombinedBAM $MatBAM $PatBAM $mat1 $pat1
